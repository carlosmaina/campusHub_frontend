...
export function TopBar({ userName }) {
  ...
  useEffect(() => {
    let FunctionNotifications = async () => {
      let notify = await fetch(
        "https://campushub-mq9h.onrender.com/api/public/notifications",
        {
          method: "GET",
          credentials: "include",
  ...
  async function DeleteAccount() {
    ...
    resetLoading(true);
    try {
      let res = await fetch("https://campushub-mq9h.onrender.com/auth/delete/account", {
        method: "POST",
        credentials: "include",
      });
      GetInfo(res);
  ...
  async function LogOut() {
    resetLoading(true);
    try {
      let res = await fetch("https://campushub-mq9h.onrender.com/auth/logout", {
        method: "POST",
        credentials: "include",
      });
      GetInfo(res);
  ...
  let LogOutAll = async () => {
    try {
      let res = await fetch("https://campushub-mq9h.onrender.com/auth/all/logout", {
        method: "POST",
        credentials: "include",
      });
      GetInfo(res);
